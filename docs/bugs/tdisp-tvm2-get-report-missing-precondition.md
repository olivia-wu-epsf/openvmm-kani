...
blockers as TVM-1 / TVM-3: the activate path issues GET_REPORT only
as the third step of a multi-command attest cycle, requiring a
...
`VpciClientTdispState::tdisp_get_device_report` primitive layer.
